...
import { CursorArrowRaysIcon, PlusSmallIcon } from "@heroicons/react/24/outline";
					...
					return (
						<>
							...
							>
								...
								{isHovered && <CursorArrowRaysIcon className="h-4 w-4 text-slate-400" />}
								<div className="min-w-fit">
									<PlusSmallIcon className={`${open ? "rotate-45" : ""} h-4 w-4 text-slate-500`} />
								</div>
							</Disclosure.Button>
							<Disclosure.Panel>
