				...
				{({ open }) => {
					return (
						<>
							<Disclosure.Button
								as="div"
								className="flex w-full flex-row items-center justify-between p-2 text-left hover:bg-slate-200"
							>
								...
								<ChevronUpIcon className={`${open ? "" : "rotate-180"} h-5 w-5 text-slate-500`} />
							</Disclosure.Button>
