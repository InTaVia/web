export class Origin {
  ...
  toString(): string {
    console.warn('This method should not be used in combination with d3-brush components inside SVG foreignObjects. See https://github.com/InTaVia/web/issues/41');
